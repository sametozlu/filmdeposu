...
namespace FilmSerileri.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReleaseYearStart = table.Column<int>(type: "INTEGER", nullable: false),
                    ReleaseYearEnd = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "TEXT", nullable: false),
                    SeriesId = table.Column<string>(type: "TEXT", nullable: false),
                    MovieOrder = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeriesEntityId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeriesCast", x => x.RowId);
                    table.ForeignKey(
                        name: "FK_SeriesCast_Series_SeriesEntityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeriesMovies", x => x.RowId);
                    table.ForeignKey(
                        name: "FK_SeriesMovies_Series_SeriesEntityId",
                        column: x => x.SeriesEntityId,
                        principalTable: "Series",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_UserId_SeriesId",
                table: "Reviews",
                columns: new[] { "UserId", "SeriesId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SeriesCast_SeriesEntityId",
                table: "SeriesCast",
                column: "SeriesEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_SeriesMovies_SeriesEntityId",
                table: "SeriesMovies",
                column: "SeriesEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_UserNotes_UserId_SeriesId",
                table: "UserNotes",
                columns: new[] { "UserId", "SeriesId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WatchedItems_UserId_SeriesId_MovieOrder",
                table: "WatchedItems",
                columns: new[] { "UserId", "SeriesId", "MovieOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_WatchlistItems_UserId_SeriesId",
